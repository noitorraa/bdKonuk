...
namespace bdKonukIvanpr22._106.Forms
{
    public partial class Studenti : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "_22_106_10_KafedraDataSet.Studenti". При необходимости она может быть перемещена или удалена.
            this.studentiTableAdapter.Fill(this._22_106_10_KafedraDataSet.Studenti);
